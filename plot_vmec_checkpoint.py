...
def plot_plasma_geometry(
    ...
    if compare_with is not None:
        ...
        ax3d_main = fig.add_subplot(2, 3, 1, projection='3d')
        ax3d_compare = fig.add_subplot(2, 3, 2, projection='3d')
        ax2d = fig.add_subplot(2, 3, 3)
        ax_diff = fig.add_subplot(2, 3, 4)  # 差异放大视图
        ax_multi = fig.add_subplot(2, 3, 5)  # 多截面视图
        ax_info = fig.add_subplot(2, 3, 6)  # 信息面板
        ax_info.axis('off')
    else:
