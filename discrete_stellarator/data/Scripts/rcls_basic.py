...
Optimizes a basic 8x12 wireframe with the RCLS method as shown in Section 3.2
of the paper.

Outputs 2d plot of the current distribution in one half-period, as well as a
VTK model of the wireframe.
"""
...
pl.savefig(OUT_DIR + 'rcls_basic_curr2d.png')
wf.to_vtk(OUT_DIR + 'rcls_basic_model')
